...
if +(r2 - r3) < r1 < (r2 + r3) and r1 == r2 == r3:
    print("\nA união dessas retas pode sim formar um triângulo, sendo ele equilátero.")
elif +(r2 - r3) < r1 < (r2 + r3) and r1 != r2 != r3:
    print("\nA união dessas retas pode sim formar um triângulo, sendo ele escaleno.")
elif +(r2 - r3) < r1 < (r2 + r3) and r1 == r2 != r3:
    print("\nA união dessas retas pode sim formar um triângulo.")
elif +(r2 - r3) < r1 < (r2 + r3) and r1 != r2 == r3:
    print("\nA união dessas retas pode sim formar um triângulo.")
elif +(r2 - r3) < r1 < (r2 + r3) and r1 == r3 != r2:
    print("\nA união dessas retas pode sim formar um triângulo.")
else:
